...
if ( _amount > _bank_amount ) exitWith {
  systemChat format[
    "You do not have enough money on your bank account to withdraw $%1", /* TODO: Localize */
    strM(_amount)];
};
...
systemChat format["You have withdrawn $%1 from your bank account", strM(_amount)]; /* TODO: Localize */