...
private ["_client", "_nationality", "_pfamily", "_families", "_invitations", "_family", "_index"];
...
if(_client call ML_fnc_Family_InFamily)then{
    ...
    if(_nationality != (_pfamily select 5))exitWith{systemChat "Your family is not this nationality, get out of here fast!"; false};
...
buttonSetAction [IDC_ML_FAMILY_LISTJOIN, format["[lbValue [%1, lbCurSel %1]] call ML_fnc_Family_Join;", IDC_ML_FAMILY_LISTL]];
