...
if ((_quest select 1) != "") then {
  [objectFromNetId (_quest select 1), (_quest select 0), "Quest_Action_HandIn", ML_fnc_Quests_HandIn, "Quest_HandIn"] call ML_fnc_Quests_AddAction;
} else {
...
["ML_Info", ["Quest Accepted!", "\ML_Images\Actions\Quest_Icon.paa", format["<t color='#01DF01'>You accepted: '%1'!</t>", (_quest select 2)]]] call ML_fnc_showNotification;
